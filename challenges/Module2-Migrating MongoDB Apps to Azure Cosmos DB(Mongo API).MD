...
Here you should see the current throughput and options to increase/decrease the throughput. You can make the necessary changes and Click **Save**.<br/>

    ![scalethroughput](../images/scalethroughput.png)
